...
from Models.SKAttention import SKAttention
...
class RepBlock_SK(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        self.sk = SKAttention(channel=512, reduction=8)
    ...
    def forward(self, inputs):
        ...
        channel_att_vec = self.sk(inputs)
...
if __name__ == '__main__':
    ...
    repmlp_block = RepBlock_SK(in_channels=512, out_channels=512, channelAttention_reduce=4)
    output = repmlp_block(input)
    print(output.shape)